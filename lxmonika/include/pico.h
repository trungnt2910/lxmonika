...
typedef NTSTATUS PS_PICO_CREATE_PROCESS_RS1(
    _In_ PPS_PICO_PROCESS_ATTRIBUTES ProcessAttributes,
...
typedef PS_PICO_CREATE_PROCESS_RS1 PS_PICO_CREATE_PROCESS;
#else
...
typedef NTSTATUS PS_PICO_CREATE_THREAD_RS1(
    _In_ PPS_PICO_THREAD_ATTRIBUTES ThreadAttributes,
    _In_opt_ PPS_PICO_CREATE_INFO CreateInfo,
    _Outptr_ PHANDLE ThreadHandle
);
...
#if (NTDDI_VERSION >= NTDDI_RS1)
typedef PS_PICO_CREATE_THREAD_RS1 PS_PICO_CREATE_THREAD;
#else
